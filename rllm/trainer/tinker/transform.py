...
def transform_trajectory_groups_to_datums(
    ...
    for group in trajectory_groups:
        for trajectory in group.trajectories:
            ...
            router_replay_enabled = algorithm_config.router_replay is True or algorithm_config.router_replay == "R3"
            traj_datums = trajectory_to_datums(trajectory, router_replay=router_replay_enabled)
