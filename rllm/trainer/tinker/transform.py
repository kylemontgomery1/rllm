...
def transform_trajectory_groups_to_datums(
    ...
    for group in trajectory_groups:
        for trajectory in group.trajectories:
            if algorithm_config.estimator_map:
                datums_dict[group.group_role].extend(trajectory_to_datums(trajectory, router_replay=algorithm_config.router_replay))
            else:
                datums.extend(trajectory_to_datums(trajectory, router_replay=algorithm_config.router_replay))
