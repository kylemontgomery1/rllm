...
python -m examples.agentcore_math.train_agentcore_math_fireworks \
    ...
    rllm.trainer.experiment_name=gsm8k-agentcore-fireworks-sync-4b \
    rllm.trainer.val_before_train=false \
    rllm.trainer.test_freq=-1 \
    rllm.trainer.save_freq=-1 \
    rllm.episode_logging.log_compact_rollouts=true \
    rllm.episode_logging.compact_rollout_dir='logs/gsm8k-agentcore-fireworks-sync-4b-try1-training-rollouts/'
